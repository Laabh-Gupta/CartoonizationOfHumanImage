    ...
    def save_networks(self, epoch):
        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                # Get underlying model if wrapped in DataParallel
    ...
    def load_networks(self, epoch):
        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                # Load state dict to appropriate device
                ...
                for key in list(state_dict.keys()):
                    self.__patch_instance_norm_state_dict(state_dict, net_to_load, key.split('.'))
